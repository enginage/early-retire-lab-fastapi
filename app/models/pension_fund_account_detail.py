...
class PensionFundAccountDetail(Base):
    __tablename__ = "pension_fund_account_detail"
    
    id = Column(Integer, primary_key=True, index=True)
    account_id = Column(Integer, ForeignKey("pension_fund_account.id"), nullable=False)  # 연금저축펀드 계좌 ID
    ...
    # 관계 설정
    account = relationship("PensionFundAccount", back_populates="details")
