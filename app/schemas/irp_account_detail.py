...
class IRPAccountDetailBase(BaseModel):
    account_id: int  # IRP 계좌 ID
    stock_code: str  # 종목코드
    quantity: Decimal  # 수량
...
class IRPAccountDetailCreate(IRPAccountDetailBase):
    pass

class IRPAccountDetailUpdate(IRPAccountDetailBase):
    pass

class IRPAccountDetail(IRPAccountDetailBase):
    id: int
